...
var format_Equipementsdesant_9 = new ol.format.GeoJSON();
var features_Equipementsdesant_9 = format_Equipementsdesant_9.readFeatures(json_Equipementsdesant_9, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_Equipementsdesant_9 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_Equipementsdesant_9.addFeatures(features_Equipementsdesant_9);
var lyr_Equipementsdesant_9 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_Equipementsdesant_9, 
                style: style_Equipementsdesant_9,
                popuplayertitle: 'Equipements de santé',
                interactive: true,
                title: '<img src="styles/legend/Equipementsdesant_9.png" /> Equipements de santé'
            });
var format_Equipementadministratifs_10 = new ol.format.GeoJSON();
var features_Equipementadministratifs_10 = format_Equipementadministratifs_10.readFeatures(json_Equipementadministratifs_10, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_Equipementadministratifs_10 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_Equipementadministratifs_10.addFeatures(features_Equipementadministratifs_10);
var lyr_Equipementadministratifs_10 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_Equipementadministratifs_10, 
                style: style_Equipementadministratifs_10,
                popuplayertitle: 'Equipement administratifs',
                interactive: true,
                title: '<img src="styles/legend/Equipementadministratifs_10.png" /> Equipement administratifs'
            });

lyr_OpenStreetMap_0.setVisible(true);lyr_CUEkmz_1.setVisible(true);lyr_contours_2.setVisible(true);lyr_Flux_3.setVisible(true);lyr_p10_4.setVisible(true);lyr_Voiesbitumesnonpraticable_5.setVisible(true);lyr_D3_6.setVisible(true);lyr_voiessecondaires_7.setVisible(true);lyr_voiebitumepraticable_8.setVisible(true);lyr_Equipementsdesant_9.setVisible(true);lyr_Equipementadministratifs_10.setVisible(true);
var layersList = [lyr_OpenStreetMap_0,lyr_CUEkmz_1,lyr_contours_2,lyr_Flux_3,lyr_p10_4,lyr_Voiesbitumesnonpraticable_5,lyr_D3_6,lyr_voiessecondaires_7,lyr_voiebitumepraticable_8,lyr_Equipementsdesant_9,lyr_Equipementadministratifs_10];
...
lyr_Equipementsdesant_9.set('fieldAliases', {'id': 'id', });
lyr_Equipementadministratifs_10.set('fieldAliases', {'id': 'id', });
...
lyr_Equipementsdesant_9.set('fieldImages', {'id': 'TextEdit', });
lyr_Equipementadministratifs_10.set('fieldImages', {'id': 'TextEdit', });
...
lyr_Equipementsdesant_9.set('fieldLabels', {'id': 'header label - always visible', });
lyr_Equipementadministratifs_10.set('fieldLabels', {'id': 'header label - always visible', });
lyr_Equipementadministratifs_10.on('precompose', function(evt) {
